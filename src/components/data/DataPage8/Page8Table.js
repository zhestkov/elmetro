...
import { Page8TableModel } from "../../../models/tables/Page8TableModel";
...
@observer
export class Page8Table extends React.Component<Props> {
  state = {
    dataTableModel: new Page8TableModel("data-page-8")
  };
